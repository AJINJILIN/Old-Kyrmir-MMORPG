...
Trade["Eomer"] = {
	...
	{ menu  = 19, item = "ITAR_CORANGAR", cost = 100000, amount = 1 },
	{ menu  = 20, item = "ITAR_PAL_M", cost = 100000, amount = 1 },
	{ menu  = 21, item = "ITAR_DJG_L", cost = 100000, amount = 1 },
}
...
Trade["Rafer"] = {
	...
	{ menu  = 15, item = "ITMW_1H_BLESSED_03", cost = 100000, amount = 1 },
}
...
Trade["Gerald"] = {
	...
	{ menu 	= 6, item = "SWORD7", cost = 11500, amount = 1 },  -- Stalowy Zabojca 80 dmg 80 sily
...
Trade["Vasilas"] = {
	...
	{ menu = 8, item = "SWORD19", cost = 340000, amount = 1 }, -- Ostrze Admira³a 170 dmg 150 sily
	...
	{ menu = 13, item = "SWORD24", cost = 250000, amount = 1 }, -- Krzy¿ Przeznaczenia 125 dmg 125 sily
};
...
Trade["Rudin"] = {
	...
	{ menu  = 6, item = "SWORD31", cost = 440000, amount = 1 }, -- Ostrze Odzia³ów Specialnych 220 dmg 200 sily
	{ menu  = 7, item = "SWORD32", cost = 410000, amount = 1 }, -- Krwawe Ostrze 205 dmg 185 sily
	{ menu  = 8, item = "SWORD33", cost = 420000, amount = 1 }, -- Miecz Dwurêczny Assasyna 210 dmg 190 sily
...
Trade["Urgan"] = {
	...
	{ menu  = 0, item = "HUM_KYRMIR", cost = 400000, amount = 1 },   -- Pancerz S³ug Cienia 165 165 165 165
	...
	{ menu  = 9, item = "HUM_KYRMIR9", cost = 100000, amount = 1 },	 -- Zbroja Rebelianta 100 100 100 100
	{ menu  = 10, item = "HUM_KYRMIR10", cost = 155000, amount = 1 }, -- Zbroja Kasty Wojownikow 145 145 125 125
	{ menu  = 11, item = "HUM_KYRMIR11", cost = 305000, amount = 1 }, -- Mroczna Zbroja 135 135 135 135
	{ menu  = 12, item = "HUM_KYRMIR12", cost = 260000, amount = 1 }, -- Zbroja Najemnika z Po³udnia 120 120 120 120
	{ menu  = 13, item = "HUM_KYRMIR13", cost = 11000, amount = 1 }, -- Wzmocniony Skorzany Pancerz 85 85 85 80
	{ menu  = 14, item = "HUM_KYRMIR14", cost = 340000, amount = 1 }, -- Pancerz Dowodcy Paladyna 150 100 100 100
	...
	{ menu  = 17, item = "HUM_KYRMIR17", cost = 159000, amount = 1 }, -- Zbroja Elitarnego Szpiega 145 145 150 150
...
function GiveItemTrade( playerid )
	...
	if GetItemCost( GetPlayerName(GetFocus(playerid)), GetPlayerOptionsNPC(playerid) ) <= GetPlayerGold(playerid) then
		...
		GameTextForPlayer(playerid, 500, 3500, "Pomyœlnie zakupiono przedmiot","Font_Old_20_White_Hi.TGA", 255, 255, 255, 500);
		...
		GameTextForPlayer(playerid, 500, 3500, "Brakuje z³ota","Font_Old_20_White_Hi.TGA", 255, 255, 255, 500);
...
function SellItemFagar( playerid, page, menu )
	...
	if page_item.menu_id == menu then
			...
			if FindItem(playerid, page_item.item) ~= false then
				...
				GameTextForPlayer(playerid, 500, 3500, "Pomyœlnie sprzedano przedmiot","Font_Old_20_White_Hi.TGA", 255, 255, 255, 500);
					
			else
				
				GameTextForPlayer(playerid, 500, 3500, "Nie posiadasz tego przedmiotu","Font_Old_20_White_Hi.TGA", 255, 255, 255, 500);
