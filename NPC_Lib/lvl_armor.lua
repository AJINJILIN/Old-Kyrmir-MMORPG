local Armor = {
	...
	{ item = "ITAR_PAL_H", lvl = 35 },
	{ item = "ITAR_DJG_M", lvl = 32 },
	{ item = "ITAR_DJG_H", lvl = 35 },
	{ item = "ITAR_NOV_L", lvl = 4 },
	{ item = "ITAR_KDF_L", lvl = 8 },
	{ item = "ITAR_KDF_H", lvl = 27 },
	{ item = "ITAR_OreBaron_Addon", lvl = 25 },
	{ item = "ITAR_DEMENTOR", lvl = 33 },
	{ item = "ITAR_KDW_H", lvl = 27 },
	{ item = "ITAR_XARDAS", lvl = 27 },
	{ item = "ITAR_LESTER", lvl = 3 },
	{ item = "ITAR_Raven_Addon", lvl = 30 },
			...
			for i, armor in ipairs(Armor) do
				...
				if curr_armor == armor.item then
					...
					if GetPlayerLevel(playerid) < armor.lvl then	
						...
						SendPlayerMessage(playerid, 255, 255, 0, "Необходимый уровень: "..armor.lvl);
