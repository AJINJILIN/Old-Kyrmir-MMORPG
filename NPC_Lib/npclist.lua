...
function SpawnNPC()
	...
	NPC.Farim = AddNPC("Фарим", 3664.3010253906, 454.35369873047, -475.42483520508, 132, "ITAR_PAL_M", "ItMw_FrancisDagger_Mis", "ItRw_Crossbow_H_02", "S_HGUARD", "Hum_Body_Naked0", 2, "Hum_Head_Pony", 104, "MMO.ZEN");
	NPC.Blyth = AddNPC("Блитз", 446.30444335938, 348.87619018555, 2316.92578125, 207, "ITAR_LEATHER_L", "ITMW_1H_SWORD_L_03", "ITRW_BOW_M_01", "S_LGUARD", "Hum_Body_Naked0", 26, "Hum_Head_Pony", 104, "MMO.ZEN");
	NPC.Will = AddNPC("Уилл", -16.403942108154, 223.79046630859, 739.87188720703, 160, "ITAR_DJG_L", "ItMw_FrancisDagger_Mis", "ItRw_Bow_H_04", "S_LGUARD", "Hum_Body_Naked0", 2, "Hum_Head_BALD", 95, "MMO.ZEN");

	--NPC.Bob = AddNPC("Bob", -10126.669921875, 200.03742218018, -19527.0703125, 120, "ITAR_BAU_L", "ItMw_1h_Bau_Axe", "", "S_RUN", "Hum_Body_Naked0", 4, "Hum_Head_FatBald", 136, "MMO.ZEN");
	--NPC.Fred = AddNPC("Fred", -9081.962890625, 217.50938415527, -18284.45703125, 14, "ITAR_BAU_M", "ITMW_1H_BAU_MACE", "", "S_LGUARD", "Hum_Body_Naked0", 2, "Hum_Head_Bald", 80, "MMO.ZEN");
	NPC.Eowina = AddNPC("Эовин", -3217.0178222656, 148.23522949219, -1902.5109863281, 273, "ITAR_BauBabe_L", "ItMw_1h_Bau_Axe", "", "S_STOVE_S1", "Hum_Body_Babe0", 6, "Hum_Head_Babe", 138, "MMO.ZEN");
	SetPlayerWeaponMode(NPC.Eowina, WEAPON_1H);
	
	--NPC.Baranir = AddNPC("Баранир", -3299.966796875, 148.04086303711, -2234.6540527344, 46, "ITAR_PAL_SKEL", "ItMw_Berserkeraxt", "", "S_HGUARD", "Hum_Body_Naked0", 2, "Hum_Head_Pony", 55, "MMO.ZEN");

	-----zamek-----
	NPC.Tyrion = AddNPC("Тирион", 433.15853881836, 247.73025512695, 1203.2509765625, 307, "ITAR_VLK_L", "ItMw_FrancisDagger_Mis", "", "S_LGUARD", "Hum_Body_Naked0", 2, "Hum_Head_Bald", 43, "MMO.ZEN");
	NPC.Eomer = AddNPC("Эомер", -4904.4272460938, -312.60787963867, -3352.5693359375, 340, "ITAR_PAL_M", "ItMw_1h_Pal_Sword", "", "T_search", "Hum_Body_Naked0", 2, "Hum_Head_FatBald", 114, "MMO.ZEN");
	NPC.Brandon = AddNPC("Брендон", 1326.7355957031, 248.09197998047, 620.65490722656, 146, "ITAR_SMITH", "ItMw_1H_Mace_L_04", "", "S_BSANVIL_S1", "Hum_Body_Naked0", 1, "Hum_Head_Bald", 46, "MMO.ZEN");
	SetPlayerWeaponMode(NPC.Brandon, WEAPON_1H);
	NPC.Bethan = AddNPC("Безан", 1012.2388305664, 344.84603881836, -1342.1375732422, 359, "ITAR_KDF_H", "ItMW_Addon_Stab02", "", "S_LGUARD", "Hum_Body_Naked0", 2, "Hum_Head_Pony", 130, "MMO.ZEN");
	NPC.Cross = AddNPC("Кросс", 2160.2995605469, 248.19995117188, 336.73760986328, 190, "ITAR_PAL_M", "ItMw_FrancisDagger_Mis", "ItRw_Crossbow_H_02", "S_LGUARD", "Hum_Body_Naked0", 2, "Hum_Head_Pony", 64, "MMO.ZEN");
	NPC.Hagan = AddNPC("Хаган", -675.79534912109, 247.70199584961, 1.5098875761032, 91, "ITAR_MIL_L", "ITMW_SCHWERT1", "", "S_LGUARD", "Hum_Body_Naked0", 2, "Hum_Head_Bald", 1, "MMO.ZEN");
	NPC.Guy = AddNPC("Гай", -4643.3208007812, -283.47695922852, -2245.6696777344, 29, "ITAR_MIL_L", "ITMW_2H_PAL_SWORD", "", "S_LGUARD", "Hum_Body_Naked0", 2, "Hum_Head_Pony", 65, "MMO.ZEN");
	NPC.Brain = AddNPC("Брейн", -4519.8525390625, -151.80868530273, -414.53967285156, 107, "ITAR_PAL_M", "ItMw_2h_Pal_Sword", "", "S_LGUARD", "Hum_Body_Naked0", 2, "Hum_Head_Pony", 66, "MMO.ZEN");
	NPC.Nieznajomy = AddNPC("Корколам", 1330.5307617188, 345.74334716797, -3387.4819335938, 181, "ITAR_SMITH", "", "", "S_LAB_S1", "Hum_Body_Naked0", 1, "Hum_Head_Bald", 31, "MMO.ZEN");
	NPC.Regin = AddNPC("Регин", 2859.4909667969, 248.18772888184, 157.05989074707, 174, "ITAR_MIL_L", "ItMw_1h_Pal_Sword", "", "T_SEARCH", "Hum_Body_Naked0", 2, "Hum_Head_Bald", 26, "MMO.ZEN");
	--NPC.Magnus = AddNPC("Magnus", -1051.0052490234, 98.178428649902, 5522.8081054688, 146, "ITAR_KDW_H", "", "", "S_LGUARD", "Hum_Body_Naked0", 2, "Hum_Head_Pony", 52, "MMO.ZEN");
	NPC.Fagar = AddNPC("Фагар", -405.00778198242, 347.70385742188, 2664.8015136719, 359, "ITAR_VLK_H", "", "", "S_LGUARD", "Hum_Body_Naked0", 4, "Hum_Head_Bald", 84, "MMO.ZEN");
	-- Jpe gerald zyskuje nowa role
	--NPC.Gerald = AddNPC("Геральд", -849.43017578125, 247.73121643066, 1203.8854980469, -3, "ITAR_VLK_H", "", "", "S_HGUARD", "Hum_Body_Naked0", 6, "Hum_Head_Bald", 124, "MMO.ZEN");
	--NPC.Vasilas = AddNPC("Василий", -1262.3657226562, 243.33187866211, 1429.6555175781, 89, "ITAR_VLK_H", "", "", "S_HGUARD", "Hum_Body_Naked0", 6, "Hum_Head_Bald", 124, "MMO.ZEN");
	--NPC.Urgan = AddNPC("Урган", -1106.9105224609, 247.71984863281, 2384.1872558594, 177, "ITAR_VLK_H", "", "", "S_HGUARD", "Hum_Body_Naked0", 6, "Hum_Head_Bald", 124, "MMO.ZEN");
	--NPC.Rudin = AddNPC("Рудин", -11.413331031799, 247.92950439453, -1385.8715820312, 42, "HUM_KYRMIR31", "", "ItMw_2h_Pal_Sword", "S_HGUARD", "Hum_Body_Naked0", 2, "Hum_Head_Bald", 86, "MMO.ZEN");	
	NPC.Nefarus = AddNPC("Нефарус", -2027.0030517578, 248.24755859375, -1988.3745117188, 359, "ITAR_VLK_H", "", "", "S_HGUARD", "Hum_Body_Naked0", 6, "Hum_Head_Bald", 124, "MMO.ZEN");
	
	-----zamek-----
	NPC.Rafer = AddNPC("Рафер", 985.5478515625, 247.85075378418, 998.18194580078, 309, "ITAR_SMITH", "ItMw_1H_Mace_L_04", "", "S_BSFIRE_S1", "Hum_Body_Naked0", 2, "Hum_Head_Thief", 57, "MMO.ZEN");
	SetPlayerWeaponMode(NPC.Rafer, WEAPON_1H);
	--NPC.Jenifer = AddNPC("Дженифер", -3107.0656738281, 49.205837249756, -3201.2966308594, 87, "ITAR_PAL_H", "ItMw_2H_Blessed_02", "", "S_HGUARD", "Hum_Body_Babe0", 6, "Hum_Head_Babe", 137, "MMO.ZEN");
	NPC.Dirkland = AddNPC("Диркланд", 2806.5300292969, 244.85255432129, -1549.7038574219, 330 , "ITAR_PAL_M", "ITMW_ELBASTARDO", "", "T_1HSFREE", "Hum_Body_Naked0", 11, "Hum_Head_Bald", 9, "MMO.ZEN");
	SetPlayerWeaponMode(NPC.Dirkland, WEAPON_1H);
	NPC.Greth = AddNPC("Грет", -427.68786621094, 237.51821899414, -1031.646484375, 43, "ITAR_CORANGAR", "ItMw_Zweihaender4", "", "S_LGUARD", "Hum_Body_Naked0", 11, "Hum_Head_FatBald", 2, "MMO.ZEN");
	NPC.Cahan = AddNPC("Каган", -2047.8784179688, 786.16918945312, -2325.2336425781, 6, "ITAR_PAL_M", "ItMw_2h_Pal_Sword", "ItRw_Crossbow_M_02", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");

	-----GD------
	--NPC.Cheamel = AddNPC("Чимел", 0, 350, 0, 266, "ITAR_MIL_M", "ItMw_Addon_BanditTrader", "", "S_RUN", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	
	----Монастырь----
	
	--NPC.Garik = AddNPC("Гарик", 778.11822509766, 347.59741210938, -3350.1037597656, 140, "ITAR_KDF_L", "", "", "S_BOOK_S1", "Hum_Body_Naked0", 1, "Hum_Head_Pony", 93, "MMO.ZEN");
	
	-----TP------
	--Монастырь
	--NPC.TP[1] = AddNPC("Телепортер", 1404.6961669922, 398.19610595703, 3957.51953125, 279, "ITAR_DEMENTOR", "", "", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	--Okolice Latarni Morskiej
	--NPC.TP[2] = AddNPC("Телепортер", 36122.3515625, 3927.6401367188, -2909.8852539063, 128, "ITAR_DEMENTOR", "", "", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	--К Хоринису
	--NPC.TP[3] = AddNPC("Телепортер", 76393.203125, 3599.5502929688, -13994.260742188, 260, "ITAR_DEMENTOR", "", "", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	--Около фермы Лобарта
	--NPC.TP[4] = AddNPC("Телепортер", 37968.6875, 4405.578125, 13816.65625, 89, "ITAR_DEMENTOR", "", "", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	--На ферму Акила
	--[[NPC.TP[5] = AddNPC("Телепортер", 30450.845703125, 2663.5402832031, 20661.509765625, 109, "ITAR_DEMENTOR", "ItMw_Addon_BanditTrader", "", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	--К дороге к монастырю
	NPC.TP[6] = AddNPC("Телепортер", 37131.33984375, 3393.6225585938, 2561.0395507812, 132, "ITAR_DEMENTOR", "ItMw_Addon_BanditTrader", "", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	--К таверне "Мертвая гарпия"
	NPC.TP[7] = AddNPC("Телепортер", 31185.361328125, 4224.5971679688, -5553.8950195313, 220, "ITAR_DEMENTOR", "ItMw_Addon_BanditTrader", "", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	--Okolice Przeікczy
	NPC.TP[8] = AddNPC("Телепортер", 45618.859375, 2978.08203125, -26747.21875, 106, "ITAR_DEMENTOR", "ItMw_Addon_BanditTrader", "", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	--К башне Декстера
	NPC.TP[9] = AddNPC("Телепортер", 64652.234375, 2469.326171875, -18583.4140625, 163, "ITAR_DEMENTOR", "ItMw_Addon_BanditTrader", "", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	--К ферме Онара
	NPC.TP[10] = AddNPC("Телепортер", 62718.5078125, 1899.5607910156, 7684.1196289063, 230, "ITAR_DEMENTOR", "ItMw_Addon_BanditTrader", "", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	--К заброшенному лагерю
	NPC.TP[11] = AddNPC("Teleporter", 48583.47265625, 3699.1018066406, 11292.814453125, 109, "ITAR_DEMENTOR", "ItMw_Addon_BanditTrader", "", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	--К мосту, перед бандитами
	NPC.TP[12] = AddNPC("Teleporter", 59281.765625, 3187.3981933594, 11460.61328125, 310, "ITAR_DEMENTOR", "ItMw_Addon_BanditTrader", "", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	--К храму Аданоса
	NPC.TP[13] = AddNPC("Teleporter", 70554.8125, 4458.9716796875, 22014.388671875, 43, "ITAR_DEMENTOR", "ItMw_Addon_BanditTrader", "", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	--К яме огненного голема
	NPC.TP[14] = AddNPC("Teleporter", 60329.8359375, 6824.1743164063, 41089.98046875, 326, "ITAR_DEMENTOR", "ItMw_Addon_BanditTrader", "", "S_LGUARD", "Hum_Body_Naked0", 3, "Hum_Head_FatBald", 123, "MMO.ZEN");
	]]
end
...
function CreatePlayerNPC(playerid)
	...
	Player.Draw = {};
	Player.Draw[0] = CreatePlayerDraw(playerid, 2950, 6850, "| 10 LP | 0 Золото", "Font_Old_10_White_Hi.TGA", 255, 255, 0);
	Player.Draw[1] = CreatePlayerDraw(playerid, 2950, 7050, "| 10 LP | 0 Золото", "Font_Old_10_White_Hi.TGA", 255, 255, 0);
...
function UpdatePlayerDraw_Stat(playerid, _type)
	...
	if _type == "Skill" then
		...
		UpdatePlayerDraw(playerid, Player[playerid].Draw[0], 2750, 6850, "| 10 LP | "..GetGoldItem( playerid, Player[playerid].Trening, 10 ).." Золото", "Font_Old_10_White_Hi.TGA", 255, 145, 0);
		UpdatePlayerDraw(playerid, Player[playerid].Draw[1], 2750, 7050, "| 5  LP | "..GetGoldItem( playerid, Player[playerid].Trening, 5 ).." Золото", "Font_Old_10_White_Hi.TGA", 255, 145, 0);

	elseif _type == "Statistic" then	
	
		UpdatePlayerDraw(playerid, Player[playerid].Draw[0], 2750, 6850, "| 10 LP | "..GetGoldItem( playerid, Player[playerid].Trening, 1 ).." Золото", "Font_Old_10_White_Hi.TGA", 255, 145, 0);
		UpdatePlayerDraw(playerid, Player[playerid].Draw[1], 2750, 7050, "| 5  LP | "..GetGoldItem( playerid, Player[playerid].Trening, 2 ).." Золото", "Font_Old_10_White_Hi.TGA", 255, 145, 0);
...
--Nieznajomy Dialog
Dialog_Nieznajomy[0] = CreateDialog("Nieznajomy_0", "Митон");
Dialog_Nieznajomy[1] = CreateDialog("Nieznajomy_1", "Митон");
Dialog_Nieznajomy[2] = CreateDialog("Nieznajomy_roz_1", "Митон");
Dialog_Nieznajomy[3] = CreateDialog("Nieznajomy_roz_2", "Митон");
Dialog_Nieznajomy[4] = CreateDialog("Nieznajomy_roz_3", "Митон");
Dialog_Nieznajomy[5] = CreateDialog("Nieznajomy_roz_4", "Митон");
Dialog_Nieznajomy[6] = CreateDialog("Nieznajomy_roz_5", "Митон");
Dialog_Nieznajomy[7] = CreateDialog("Nieznajomy_skup", "Митон");
Dialog_Nieznajomy[8] = CreateDialog("Nieznajomy_odrzucenie", "Митон");
...
function StartDialogGreth(playerid)
	...
	elseif Player[playerid].Greth == 1 then
		...
		if GetPlayerActiveMenu(playerid, Menu_Greth[1]) == 0 then
			...
			HideMenuGreth(playerid);
			DialogStart(playerid, Dialog_Greth[1], Menu_Trening["Health"], 1, 0);
			Player[playerid].Dialog = true;
			Player[playerid].Trening = "Health";
...
Menu_TP[1] = CreateMenu(4, "(КОНЕЦ)", Texture_Menu_NPC, 1450, 6850, "Font_Old_10_White_Hi.TGA", 200, 255, 255, 255, 255, 255, 0, "TP1");
Menu_TP[2] = CreateMenu(4, "(КОНЕЦ)", Texture_Menu_NPC, 1450, 6850, "Font_Old_10_White_Hi.TGA", 200, 255, 255, 255, 255, 255, 0, "TP2");
Menu_TP[3] = CreateMenu(4, "(КОНЕЦ)", Texture_Menu_NPC, 1450, 6850, "Font_Old_10_White_Hi.TGA", 200, 255, 255, 255, 255, 255, 0, "TP3");
Menu_TP[4] = CreateMenu(4, "(КОНЕЦ)", Texture_Menu_NPC, 1450, 6850, "Font_Old_10_White_Hi.TGA", 200, 255, 255, 255, 255, 255, 0, "TP4");
		...
		if Player[playerid].Magnus == 1 then
			...
			if Player[playerid].TP == true then
				...
				if GetPlayerLevel(playerid) >= GD_Gothic2_Lvl then
					...
					SetPlayerWorld(playerid,"MMO.ZEN","WP_INTRO13");
					EndNPC(playerid);
